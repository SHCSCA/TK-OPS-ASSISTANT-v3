...
## Corpus Check
- 405 files · ~973,788 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2821 nodes · 7469 edges · 182 communities detected
...
Cohesion: 0.02
Nodes (106): CreateProjectInput, CurrentProjectContextDto, DashboardCurrentActionDto, DashboardPendingItemDto, DashboardRiskItemDto, DashboardRiskSummaryDto, DashboardSummaryDto, DashboardTaskDto (+98 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (120): AccountRepository, _utc_now(), runtime_app(), error_response(), create_app(), RenderRepository, sleep(), SubtitleRepository (+112 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (78): AccountService, _is_auth_expired(), _mask_sensitive_json(), _mask_value(), _utc_now(), AccountBindingDto, AccountBindingSummaryDto, AccountBindingUpsertInput (+70 more)
...
Cohesion: 0.03
Nodes (98): ABC, AIJobRepository, StoredAIJobRecord, _utc_now(), AITextGenerationService, GeneratedTextResult, _render_template(), AnthropicMessagesTextGenerationAdapter (+90 more)
...
Cohesion: 0.03
Nodes (82): TTSRequest, TTSResponse, build_parser(), main(), build_parser(), copy_to_clipboard(), main(), resolve_machine_code() (+74 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (61): if(), load_runtime_config(), _load_runtime_version(), RuntimeConfig, create_app(), UnavailableLicenseActivationAdapter, activate_license(), ActivationResult (+53 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (67): AICapabilityChangedEventDto, AICapabilityConfigDto, AICapabilityModelOptionDto, AICapabilitySettingsDto, AICapabilitySupportItemDto, AICapabilitySupportMatrixDto, AIDiagnosticSummaryDto, AIModelCatalogItemDto (+59 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (54): AICapabilityConfigListInput, AIProviderHealthCheckInput, AIProviderSecretInput, BaseModel, BootstrapActionDto, BootstrapBlockerDto, BootstrapDirectoryItemDto, BootstrapDirectoryReportDto (+46 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (70): Account, AccountGroup, AccountGroupMember, 更新 updated_at（用于 refresh-stats V1 占位）, AICapabilityConfig, AIProviderHealth, AIProviderModel, AIProviderSetting (+62 more)
...
Cohesion: 0.06
Nodes (30): AutomationTaskActionDto, AutomationTaskCreateInput, AutomationTaskDto, AutomationTaskLatestResultDto, AutomationTaskQueueDto, AutomationTaskRetryDto, AutomationTaskRuleDto, AutomationTaskRuleInput (+22 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (29): platformLabel(), formatDateTime(), formatDateTime(), _BuiltinSubtitleStyleTemplate, SubtitleService, SubtitleAlignmentDiffSummaryDto, SubtitleAlignmentDto, SubtitleExportDto (+21 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (53): add business modules  Revision ID: 0003_add_business_modules Revises: 0002_ad, upgrade(), merge runtime migration heads  Revision ID: 0006_merge_runtime_heads Revises:, upgrade(), add ai provider models and browser instances  Revision ID: 0007_add_ai_provider_, upgrade(), create_runtime_engine(), _ensure_table_columns() (+45 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (16): TaskInfo, ApplyVideoExtractionResultDto, ImportedVideoDto, ImportVideoInput, StoredVideoStageRun, _utc_now(), VideoDeconstructionRepository, _import_stage_state() (+8 more)
...
Cohesion: 0.07
Nodes (33): ImportedVideo, ImportedVideoRepository, error(), handleCopyContent(), test_ws_manager_injects_schema_version(), _make_repository(), _make_service(), RecordingTaskManager (+25 more)
...
- **Thin community `Community 148`** (1 nodes): `VoiceProfileGrid.vue`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (1 nodes): `SetupLicenseWizardPage.vue`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `ok_response()` connect `Community 3` to `Community 0`, `Community 1`, `Community 7`, `Community 8`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `create_app()` connect `Community 7` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `now()` connect `Community 14` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 21`, `Community 22`?**
