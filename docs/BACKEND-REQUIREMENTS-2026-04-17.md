...
>
> **2026-04-24 复核覆盖**：本文 0.1.2 与逐页缺口表中的“未文档化 / 未登记”数量已经被后续实现覆盖。当前 HTTP 路由登记状态以 `docs/RUNTIME-API-CALLS.md` 为准：文档 181 条、FastAPI 注册 181 条、已实现未文档化 0。请勿再把本文中的 M10-M14 未登记数量作为派工依据。
> 
> 后续 V2 收口请优先参考：
